...
export default function Card({
  ...
  return (
    <article
      className="flex h-full bg-card w-96 flex-col rounded-xl p-3 transition-all duration-300 hover:ring-primary/40 hover:-translate-y-0.5 sm:h-40 sm:w-full sm:max-w-xl sm:flex-row ring-1 ring-border"
