export function BackgroundWall() {
  return (
    <div className="fixed inset-0 -z-10 h-full w-full bg-white dark:bg-gray-900">
      ...
      <div className="fixed bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_800px_at_100%_200px,rgb(200,200,255),transparent)] opacity-70 animate-pulse backdrop-blur-xs dark:hidden" />
      ...
      <div className="fixed bottom-0 left-0 right-0 top-0 bg-[radial-gradient(circle_800px_at_0%_800px,rgb(255,200,200),transparent)] opacity-70 animate-pulse delay-1000 backdrop-blur-xs dark:hidden" />
